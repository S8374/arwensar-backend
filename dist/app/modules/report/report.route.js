...
// ========== MAIN REPORT ROUTES ==========
router.post('/', (0, planLimitMiddleware_1.checkUsage)('reportsGeneratedUsed', 1), (0, validateRequest_1.default)(report_constant_1.reportValidation.generateReport), report_controller_1.ReportController.generateReport);
router.post('/bulk', (0, validateRequest_1.default)(report_constant_1.reportValidation.bulkGenerate), (0, planLimitMiddleware_1.checkUsage)('reportsGeneratedUsed', 1), report_controller_1.ReportController.bulkGenerateReports);
